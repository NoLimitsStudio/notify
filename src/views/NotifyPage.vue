...
export default {
  ...
  methods: {
    getMessages () {
      this.$store.dispatch('apiMessages')
    }
  },
  mounted () {
    this.$store.dispatch('apiMessages')
